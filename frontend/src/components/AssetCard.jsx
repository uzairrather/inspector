...
const AssetCard = ({ asset }) => {
  return (
    <div className="cursor-default bg-white rounded-xl border border-gray-200 p-5 shadow-sm hover:shadow-md transition duration-300 flex flex-col justify-between">
